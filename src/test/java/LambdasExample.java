...
public class LambdasExample {
    ...
    void compareTest (){
        ...
        MyComparator <Category> compareBayNameUsingStream = new MyComparator<Category>() {
            @Override
            public int customCompare(Category obj1, Category obj2) {
                return obj1.getName().compareTo(obj2.getName());
            }
        };
        int customCompareByStringName = compareBayNameUsingStream.customCompare(category1,category2);
...
//        };
    ...
    void compareTwoTypes(){
        ...
        MyBiComparator<Integer,String> myBiComparatorUsingNumericValue = (a,b) -> a.compareTo(Integer.valueOf(b));
